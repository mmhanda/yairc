...
#    Updated: 2023/03/30 20:43:07 by mhanda           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
./commands/check_PRIVMSG.cpp ./commands/check_MODE.cpp ./commands/check_TOPIC.cpp ./commands/check_KICK.cpp ./bot.cpp
...
$(NAME) : $(OBJF) headers/server.hpp headers/user.hpp headers/channel.hpp ./bot.hpp headers/parser.hpp 
